...
Estado en memoria (se pierde al reiniciar el backend)

No hay persistencia de partidas

No hay autenticación

No está preparado para múltiples instancias

Estas limitaciones son intencionadas para simplificar el proyecto.
